...
## 딕셔너리 구성
spiderMan = { 'name':'Petter Parker', 'age':18,'weapon':'Web shooter','friends':['ironMan','Thor','Captin America']}
...
print(spiderMan.items()) # 딕션너리 모든 아이템 출력
...
## 집합: 중복허용x, 순서x
# set([1,2,3,4,3,4,2,1]) = {1,2,3,4} {3,4,1,2}